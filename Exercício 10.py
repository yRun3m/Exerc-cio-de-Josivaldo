...
pedido1.adicionar_item(nome_item="Pizza", preco_item=10)
pedido1.adicionar_item(nome_item="Churros", preco_item=5)
pedido1.adicionar_item(nome_item="Limonada", preco_item=3)
